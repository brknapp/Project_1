...
# rmarkdown::render("C:/Users/Bridget/OneDrive/R_Scripts/R_Markdown_Homework_PDF.Rmd", 
...
In order to get information from the OMDb API, we have to build a URL with our search criteria. It's similar to doing a Google search.
...
by_search("5c7f9206","star_wars",type="movie")
```
