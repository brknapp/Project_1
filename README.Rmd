...
We can also do this for one column. Let's calculate the average and standard deviation of the imdbVotes column:
...
It looks like the movies that both won awards and were nominated for awards recieved the most number of imdbVotes on average.

On a different note, if you wanted to see how many movies were made each year, you could make a histogram showing the distribution of of the "Year" column:
