...
So, for example, it looks like there are 7 movies that are classified under the "Horror, Thriller" genre.
...
So, for example, it looks like 5 movies were rated PG and fell under the "Action, Adventure, Fantasy" genre.
